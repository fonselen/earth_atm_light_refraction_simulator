...
typedef struct
{
	...
	double camada_h[5001];	// define a altura de cada camada atmosferica
	double n[5001]; 		// define indice de refracao de cada camada atmosferica
...
int main(int argc, char* argv[])
{
	...
	printf("\nangulo Raio 1: %.15lf", atan((L_ray1[nray1].B.y - L_ray1[nray1].A.y) / (L_ray1[nray1].B.x - L_ray1[nray1].A.x)) * 180 / pi);

	for (i = 0; i <= nray2; i++)
	{
		//if (i >= 3000) printf("\n  P%d = (%.15lf; %.15lf)    d = %.10lf", i, L_ray2[i].B.x, L_ray2[i].B.y, sqrt(L_ray2[i].B.x * L_ray2[i].B.x + L_ray2[i].B.y * L_ray2[i].B.y));
	}
	printf("\nangulo Raio 2: %.15lf", atan((L_ray2[nray2].B.y - L_ray2[nray2].A.y) / (L_ray2[nray2].B.x - L_ray2[nray2].A.x)) * 180 / pi);

	for (i = 0; i <= nray3; i++)
	{
		//if (i >= 3000) printf("\n  P%d = (%.15lf; %.15lf)    d = %.10lf", i, L_ray3[i].B.x, L_ray3[i].B.y, sqrt(L_ray3[i].B.x * L_ray3[i].B.x + L_ray3[i].B.y * L_ray3[i].B.y));
	}
	printf("\nangulo Raio 3: %.15lf", atan((L_ray3[nray3].B.y - L_ray3[nray3].A.y) / (L_ray3[nray3].B.x - L_ray3[nray3].A.x)) * 180 / pi);

	for (i = 0; i <= nray4; i++)
	{
		//if (i >= 3000) printf("\n  P%d = (%.15lf; %.15lf)    d = %.10lf", i, L_ray4[i].B.x, L_ray4[i].B.y, sqrt(L_ray4[i].B.x * L_ray4[i].B.x + L_ray4[i].B.y * L_ray4[i].B.y));
	}
	printf("\nangulo Raio 4: %.15lf", atan((L_ray4[nray4].B.y - L_ray4[nray4].A.y) / (L_ray4[nray4].B.x - L_ray4[nray4].A.x)) * 180 / pi);
