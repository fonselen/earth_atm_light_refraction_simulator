...
int main(int argc, char* argv[])
{
	...
	reta_xy L_ray1[12000], L_ray2[12000], Tangent_Line[1]; 	// declaração do conjunto de direções que representara o raio de luz na atmosfera
	ponto_xy Po1, Po2, Pcam, obs;			// pontos iniciais
	...
	ang1 = 3.140215505921482;
	ang2 = 3.139880644665152;
	...
	DataShow(obs, Tangent_Line[0].B, L_ray1[0].A, L_ray2[0].A, L_ray1[9299].A, L_ray2[8002].A);
	...
	viewport_LightRay_render(Tangent_Line, Pcam.x, Pcam.y, z, 0, luz_cor3); //visualizacao da linha tangente
...
void DataShow(ponto_xy Obs, ponto_xy TangentP, ponto_xy TUp, ponto_xy TDown, ponto_xy RefP1, ponto_xy RefP2)
{
	...
	printf("\n Distancia observadr-alvo: %.4lf km", dist);
	...
	printf("\n Distancia da linha do horizonte: %.4lf km", dist);
	...
	printf("\n Distancia do ponto de reflexao do raio inferior: %.4lf km", dist);
