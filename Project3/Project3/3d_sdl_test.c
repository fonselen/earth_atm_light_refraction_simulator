...
int main(int argc, char* argv[])
{
	...
	reta_xy L_ray1[12000], L_ray2[12000]; 	// declaração do conjunto de direções que representara o raio de luz na atmosfera
	...
	Po1.y = T.raio - 0.001;				// atribuindo ponto de Teste y
	Po2.x = 8;
	Po2.y = T.raio - 0.004;
	...
	nray1 = teste_2(L_ray1, &T, Po1, 3.979 * pi / 4 /*4*pi/4*/, 14);
	nray2 = teste_2(L_ray2, &T, Po2, 3.978345 * pi / 4 /*4*pi/4*/, 14);
